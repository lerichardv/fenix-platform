						...
						<table class="table table-responsive table-condensed table-striped" id="dev-table">
							<thead>
								<tr class="active info">
									...
									<th width="15%" class="translate" data-traducir_english="Lot code" data-traducir_spanish="ódigo Lote">ódigo Lote</th>
									...
									<th width="15%" class="translate" data-traducir_english="Initial Size at harvest" data-traducir_spanish="Inicio Tamaño de cosecha">Inicio Tamaño de cosecha</th>
									<th width="15%" class="translate" data-traducir_english="Final Size at harvest" data-traducir_spanish="Final Tamaño de cosecha">Final Tamaño de cosecha</th>
									...
									<th width="15%" class="translate" data-traducir_english="Time of harvest" data-traducir_spanish="Tiempo de cosecha">Tiempo de cosecha</th>
									...
									<!-- <th width="15%" class="translate" data-traducir_english="Average tote weight reported" data-traducir_spanish="Peso promedio de la caja reportada">Peso promedio de la caja reportada</th> -->
									<!-- <th width="15%" class="translate" data-traducir_english="Real average tote weight" data-traducir_spanish="Porcentaje real del peso de la caja">Porcentaje real del peso de la caja</th> -->
									...
									<!-- <th width="15%" class="translate" data-traducir_english="Pickup truck checkin" data-traducir_spanish="Hora de llegada del camión">Hora de llegada del camión</th> -->
