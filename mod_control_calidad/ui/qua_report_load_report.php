	                            	...
	                            	if (count($PLANTACIONES) > 0) {
	                            		...
	                            		foreach ($PLANTACIONES as $plantacion)
	                            		{
	                            			$cuerpo_tabla .= '<tr>'.
	                            									...
	                            									'<td>'.($plantacion['fecha_orden'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['fecha_orden'])->format("m-d-Y"):'').'</td>'.
	                            									'<td>'.($plantacion['fecha_orden'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['fecha_orden'])->format("h:i:sa"):'').'</td>'.
	                            									...
	                            									'<td>'.($plantacion['inicial_time_harvest'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['inicial_time_harvest'])->format("m-d-Y"):'').'</td>'.
	                            									'<td>'.($plantacion['inicial_time_harvest'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['inicial_time_harvest'])->format("h:i:sa"):'').'</td>'.
	                            									'<td>'.($plantacion['final_time_harvest'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['final_time_harvest'])->format("m-d-Y"):'').'</td>'.
	                            									'<td>'.($plantacion['final_time_harvest'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['final_time_harvest'])->format("h:i:sa"):'').'</td>'.
	                            									'<td>'.utf8_encode($plantacion['temperature_product']).'</td>'.
	                            									'<td>'.($plantacion['time_receiving'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['time_receiving'])->format("m-d-Y"):'').'</td>'.
	                            									'<td>'.($plantacion['time_receiving'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['time_receiving'])->format("h:i:sa"):'').'</td>'.
	                            									...
	                            									'<td>'.($plantacion['time_vacuum_cooler'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['time_vacuum_cooler'])->format("m-d-Y"):'').'</td>'.
	                            									'<td>'.($plantacion['time_vacuum_cooler'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['time_vacuum_cooler'])->format("h:i:sa"):'').'</td>'.
	                            									'<td>'.utf8_encode($plantacion['temperature_vacuum_cooler']).'</td>'.
	                            									'<td>'.utf8_encode($plantacion['hydrocooling'] == 1 ? 'Yes':'No').'</td>'.
	                            									'<td>'.($plantacion['time_pickup'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['time_pickup'])->format("m-d-Y"):'').'</td>'.
	                            									'<td>'.($plantacion['time_pickup'] != null ? DateTime::createFromFormat("m-d-Y H:i:s", $plantacion['time_pickup'])->format("h:i:sa"):'').'</td>'.
