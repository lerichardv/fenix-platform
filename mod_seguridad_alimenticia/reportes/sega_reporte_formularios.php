...
if (isset($fecha_final)) {
	$FORMULARIOS = $DB_CONF->conf_obtener_listado_mis_formularios($fecha_inicial, $fecha_final, $cod_info_empresa, $cod_formulario, 0);
}
...
<script>
	$(document).ready(function(){
		...
		$( "#excel" ).click(function() {
			...
			var url = "mod_seguridad_alimenticia/reportes/sega_reporte_formularios_excel.php?x1="+x1+"&x2="+x2+"&x3="+x3+"&x4="+x4;
		...
		$('#buscar').click(function(event) {
	        ...
	        if (error == 0)
	        {
	            ...
	            $('#modal_loading').on('hidden.bs.modal', function () {
	                $.ajax({
	                	url: 'mod_seguridad_alimenticia/reportes/sega_reporte_formularios.php',
	                	type: 'POST',
	                	dataType: 'html',
	                	data: {
...
<div class="panel panel-default">
  	<div class="panel-body">
        <div class="page-header">
            <h1 class="translate" data-traducir_english="Forms Report" data-traducir_spanish="Reporte de Formularios">Reporte de Formularios</h1>
        </div>
		<div class="row">
			<div class="col-md-2">
