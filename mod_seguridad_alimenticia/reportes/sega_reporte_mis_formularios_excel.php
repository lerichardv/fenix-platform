...
$FORMULARIOS = $DB_CONF->conf_obtener_listado_mis_formularios_excel($fecha_inicial, $fecha_final, $cod_info_empresa, $cod_formulario, $_SESSION['cod_usuario']);
/* EXCEL */
...
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('B1', 'Farming Farming');
// Titulo principal
...
$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('B2', 'Farming Farming: My Forms '.$FORMULARIOS[0]['nombre_formulario'].' from ' . $fecha_inicial . ' to ' . $fecha_final);
// Titulos de columnas
...
header('Content-Disposition: attachment;filename="My Forms - '.$FORMULARIOS[0]['nombre_formulario'].'.xlsx"');
