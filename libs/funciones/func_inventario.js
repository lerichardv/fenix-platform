...
function inv_guardar_inventario_semilla(codigo_inventario_semilla) {
    ...
    console.log({ codigo_inventario_semilla });
    $.ajax({
        ...
        data: {
            ...
            x31: 1, // Todas las germinaciones se calculan automaticamente
            x32: 1  //Asignamos el tipo de semilla a 1 de forma predeterminada,
...
/*
 * Función que obtiene los provedores consolidados
 */
function inv_constructor_grupo_proveedores() {
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/funciones/inv_listado_proveedores_grupo.php',
        dataType: 'json',
        success: function (data) {
            $('#cod_proveedor').empty();
            //$('#cod_proveedor').append(new Option('Select', '-b'))
            if (data != null) {
                if (data.length > 1) {
                    $.each(data, function (i, item) {
                        $('#cod_proveedor').append(new Option(item.proveedor, item.cod_proveedor));
                    });
                } else {
                    $('#cod_proveedor').append(new Option(data[0].proveedor, data[0].cod_proveedor));
                }
            } else {
                $('#cod_proveedor').append(new Option('No hay opciones', '-b'));
            }
            ...
            if (data != null) {
                if (data.length > 1) {
                    $.each(data, function (i, item) {
                        ...
                        $('#' + id).append('<option data-precio="' + item.precio_unidad + '" value="' + item.cod_detalle + '" data-flag_tipo_inventario="' + item.flag_tipo_inventario + '">' + item.nombre_producto + ' (' + item.codigo_producto + ')</option>');
                    });
                } else {
                    //$('#' + id).append(new Option(data[0].nombre_contacto + ' - ' + (data[0].activo == 1 ? 'Activado':'Desactivado'), data[0].cod_proveedor));
                    $('#' + id).append('<option data-precio="' + data[0].precio_unidad + '" value="' + data[0].cod_detalle + '" data-flag_tipo_inventario="' + data[0].flag_tipo_inventario + '">' + data[0].nombre_producto + ' (' + data[0].codigo_producto + ')</option>');
                }
            } else {
                $('#' + id).append(new Option('No hay opciones', '-b'));
            }
...
/*
 * Función que carga todos tickets
 */
function inv_constructor_listado_tickets(id = 'ticket') {
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/funciones/inv_listado_tickets.php',
        dataType: 'json',
        ...
        success: function (data) {
            ...
            if (data != null) {
                if (data.length > 1) {
                    $.each(data, function (i, item) {
                        $('#' + id).append(new Option(item.order_ticket, item.numero_ticket));
                    });
                } else {
                    $('#' + id).append(new Option(data[0].order_ticket, data[0].numero_ticket));
                }
            } else {
                $('#' + id).append(new Option('No options', '-b'));
            }
 ...
 * Función que carga el listado de los ragos disponibles para las semillas
 */
function inv_constructor_tipo_semilla(id = 'cod_tipo_semilla') {

    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/funciones/inv_listado_tipo_semilla.php',
        dataType: 'json',
        success: function (data) {
            $('#' + id).empty();
            $('#' + id).append(new Option('Select', '-b'));
            if (data != null) {
                if (data.length > 1) {
                    $.each(data, function (i, item) {
                        $('#' + id).append(new Option(item.nombre_tipo_semilla, item.cod_tipo_semilla));
                    });
                } else {
                    $('#' + id).append(new Option(data[0].nombre_tipo_semilla, data[0].cod_tipo_semilla));
                }
            } else {
                $('#' + id).append(new Option('No options', '-b'));
            }
 ...
 * Función que carga el listado de los sembradores activos
 */
function conf_constructor_listado_estados_de_plantacion(id = 'cod_estados', valorInicial = false) {
    $.ajax({
        type: 'POST',
 ...
 * Función que carga el listado de los sembradores activos
 */
function inv_constructor_listado_estados(id = 'cod_estado') {
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/funciones/inv_listado_estados_de_plantaciones.php',
        dataType: 'json',
                ...
                if (data != null) {
                    if (data.length > 1) {
                        $.each(data, function (i, item) {
                            ...
                            arrDatosInvernadero["cod_empresa_" + item.cod_inventario] = item.cod_empresa;
...
function inv_guardar_plantacion(datosSemillas, cantidadDeSemillasRegistradas, monstrarMensaje = true) {
    console.log(datosSemillas, cantidadDeSemillasRegistradas);
    var respuesta;
    $.ajax({
        ...
        data: {
            ...
            x3: $('#fecha_orden').val(),
            x4: datosSemillas,
            x5: cantidadDeSemillasRegistradas,
            x6: $('#cod_estados').val(),
...
function inv_actualizar_plantacion(numeroOrden_previo, datosSemillas, cantidadDeSemillasRegistradas, monstrarMensaje = true) {
    console.log(datosSemillas, cantidadDeSemillasRegistradas);
    $.ajax({
        ...
        data: {
            ...
            x2: $('#cod_info_empresa').val(),
            x3: $('#fecha_orden').val(),
            x4: cantidadDeSemillasRegistradas,
            x5: $('#cod_estados').val(),
...
function inv_constructor_listado_numero_de_orden(id = 'cod_numeros_de_orden') {
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/funciones/inv_listado_numero_orden_no_completados.php',
        dataType: 'json',
        success: function (data) {
            $('#' + id).empty();
            $('#' + id).append(new Option('Select', '-b'))
            ...
            if (data != null) {
                if (data.length > 1) {
                    $.each(data, function (i, item) {
                        ...
                        arrDatosDePlantas["cantidad_total_" + item.cod_plantacion] = item.total;

                        $('#' + id).append(new Option("(" + item.fecha_final + ") " + item.item + "- " + item.nombre_semilla + " (" + parseInt(item.total).toLocaleString() + ")", item.cod_plantacion));
                    });
                } else {
                    ...
                    arrDatosDePlantas["cantidad_total_" + data[0].cod_plantacion] = data[0].total;
                    try {
                        $('#' + id).append(new Option("(" + data[0].fecha_final + ") " + data[0].item + "- " + data[0].nombre_semilla + " (" + parseInt(data[0].total).toLocaleString() + ")", data[0].cod_plantacion));
...
// DEVn
function inv_guardar_trasplante(datosSemillas, cantidadDeSemillasRegistradas, monstrarMensaje = true) {
    var respuesta;
    $.ajax({
...
/*Funcion que permite cambiar estado activo/des de una unidad de medida
 */
function inv_cambiar_estado_completado_trasplante(cod_trasplante, valor, cod_plantacion) {
    $.ajax({
        ...
        .done(function (data) {
            ...
            var mensaje = info[1];
            info[0] == 1 ? tipo = 'danger' : tipo = 'success';
            console.log(`Nuevo estado del checkbox hijo: ${valor == 1 ? "activo" : "inactivo"}`);
            grl_mensaje('', mensaje, tipo);
            if(valor == 1){
            ...
            $(`#checkbox_hijo_${cod_trasplante}`)
              .removeAttr('onclick')
              .attr('onclick', `inv_cambiar_estado_completado_trasplante(${cod_trasplante}, ${valor == 1 ? 0 : 1}, ${cod_plantacion})`);
...
/*Funcion que permite cambiar estado activo/des de una unidad de medida
 */
function inv_cambiar_estado_completado_orden(cod_trasplante, valor) {
    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_cambiar_estado_completado_orden.php',
        type: 'POST',
        data: {
            x1: cod_trasplante,
            x2: valor
...
function inv_actualizar_trasplante(numero_ticket_previo, datosSemillas, cantidadDeSemillasRegistradas, monstrarMensaje = true) {
    $.ajax({
 ...
 */
function inv_vista_temporada(cod_temporada) {
    jQuery.ajaxSetup({
        async: false
    });
    //toggleModuleNav();
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/ui/inv_temporadas.php',
        data: {
 ...
 */
function inv_guardar_temporada(codigo_temporada) {
    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_guardar_temporada.php',
        type: 'POST',
        data: {
            x1: codigo_temporada,
        ...
        info[0] == 1 ? tipo = 'danger' : tipo = 'success';
        grl_mensaje('', mensaje, tipo);
        inv_vista_temporada(codigo_temporada)
    }).fail(function () {
        grl_mensaje('An inconvenience has occurred', 'please try later', 'danger');
    }).always(function () { });
}
...
*/
function inv_cambiar_estado_temporada(cod_temporada, valor) {

    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_cambiar_estado_temporada.php',
        type: 'POST',
        data: {
            x1: cod_temporada,
            x2: valor
 ...
 */
function inv_constructor_listado_granjas(id = 'cod_granja', valorInicial = false) {
    $.ajax({
        type: 'POST',

        url: site_url + 'mod_inventario/funciones/inv_listado_granjas.php',
        dataType: 'json',
        success: function (data) {
            $('#' + id).empty();
            if (valorInicial) {
 ...
 */
function inv_vista_granja(cod_granja) {
    jQuery.ajaxSetup({
        async: false
    });
    ...
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/ui/inv_granjas.php',
        data: {
 ...
 */
function inv_guardar_granja(codigo_granja) {
    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_guardar_granja.php',
        type: 'POST',
        data: {
            x1: codigo_granja,
        ...
        info[0] == 1 ? tipo = 'danger' : tipo = 'success';
        grl_mensaje('', mensaje, tipo);
        inv_vista_granja(codigo_granja)
    }).fail(function () {
        grl_mensaje('An inconvenience has occurred', 'please try later', 'danger');
    }).always(function () { });
}
...
*/
function inv_cambiar_estado_granja(cod_granja, valor) {

    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_cambiar_estado_granja.php',
        type: 'POST',
        data: {
            x1: cod_granja,
            x2: valor
 ...
 */
function inv_constructor_listado_campos(id = 'cod_field') {
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/funciones/inv_listado_campos.php',
        dataType: 'json',
        success: function (data) {
            $('#' + id).empty();
            if (data != null) {
 ...
 */
function inv_vista_campo(cod_field) {
    jQuery.ajaxSetup({
        async: false
    });
    ...
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/ui/inv_campos.php',
        data: {
            cod_field: cod_field
        },
        success: function (data) {
 ...
 */
function inv_guardar_campo(codigo_field) {
    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_guardar_campo.php',
        type: 'POST',
        data: {
            x1: codigo_field,
            x2: $('#nombre_campo').val(),
...
*/
function inv_cambiar_estado_campo(cod_field, valor) {

    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_cambiar_estado_campo.php',
        type: 'POST',
        data: {
            x1: cod_field,
            x2: valor
 ...
 */
function inv_constructor_listado_bloques(id = 'cod_bloque') {
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/funciones/inv_listado_bloques.php',
        dataType: 'json',
        success: function (data) {
            $('#' + id).empty();
            if (data != null) {
 ...
 */
function inv_vista_bloque(cod_bloque) {
    jQuery.ajaxSetup({
        async: false
    });
    ...
    $.ajax({
        type: 'POST',
        url: site_url + 'mod_inventario/ui/inv_bloques.php',
        data: {
 ...
 */
function inv_guardar_bloque(codigo_bloque) {
    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_guardar_bloque.php',
        type: 'POST',
        data: {
            x1: codigo_bloque,
        ...
        info[0] == 1 ? tipo = 'danger' : tipo = 'success';
        grl_mensaje('', mensaje, tipo);
        inv_vista_bloque(codigo_bloque)
    }).fail(function (error) {
        grl_mensaje('An inconvenience has occurred', 'please try later', 'danger');
    }).always(function () { });
}
...
*/
function inv_cambiar_estado_bloque(cod_bloque, valor) {

    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_cambiar_estado_bloque.php',
        type: 'POST',
        data: {
            x1: cod_bloque,
            x2: valor
 ...
 */
function inv_guardar_cantidad_acres(cod_bloque, cantidad_acres) {
    $.ajax({
        url: site_url + 'mod_inventario/funciones/inv_guardar_acres_actuales.php',
        type: 'POST',
        data: {
            x1: cod_bloque,
            x2: cantidad_acres
