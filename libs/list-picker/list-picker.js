...
class ListPicker {
    ...
    `;
		...
		this._listItemsWrapper = document.querySelector("#list-picker-items-wrapper");
		this._listSelectedItemsWrapper = document.querySelector("#list-picker-selected-items-wrapper");
		this._listPickerActionsWrapper = this._wrapperElement.querySelector('#list-picker-actions-wrapper');
    this._listPickerActionsWrapper.innerHTML = addAllButton + removeAllButton;
    this._listPickerButtonAddAll = this._listPickerActionsWrapper.querySelector('#btn-list-picker-add-all');
    this._listPickerButtonRemoveAll = this._listPickerActionsWrapper.querySelector('#btn-list-picker-remove-all');
