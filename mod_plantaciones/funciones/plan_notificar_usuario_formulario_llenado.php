                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="word-wrap:break-word;font-size:0px;padding:19px 20px 19px 20px;" align="left">
                                                                <div style="cursor:auto;color:#000000;font-family:Cabin, sans-serif;font-size:15px;line-height:22px;text-align:left;"><h2 style="color: #F05D22; line-height: 100%;"><span style="color:#16a085;">New filled form</span></h2>
                                                                    <p>Planting '.$PLANTACION[0]['anio_plantacion'].'-'.$PLANTACION[0]['num_plantacion'].'-'.$PLANTACION[0]['codigo_temporada'].' has new filled form. Please go to B&W Farming to check it.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
...
$mail->Subject = 'Notification - Planting '.$PLANTACION[0]['anio_plantacion'].'-'.$PLANTACION[0]['num_plantacion'].'-'.$PLANTACION[0]['codigo_temporada'].' - New filled form';
