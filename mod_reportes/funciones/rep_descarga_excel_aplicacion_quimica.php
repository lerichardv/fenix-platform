...
<div class="panel panel-default">
  	<div class="panel-body">
        <div class="page-header">
            <h1 class="translate" data-traducir_english="Chemical Application Excel Download" data-traducir_spanish="Descarga Excel Aplicación Química">Descarga Excel Aplicación Química</h1>
        </div>
		<div class="row">
			<div class="col-md-3">
			...
			<div class="col-md-3">
	            <label for="cod_usuarios" class="translate" data-traducir_english="Users" data-traducir_spanish="Usurios">Usuarios</label>
                <div class="form-group show-tick">
                    <select class="selectpicker show-menu-arrow requerido_semilla" multiple="multiple" title="Seleccione" id="cod_usuarios" name="cod_usuarios">
                    </select>
						...
						<table class="table table-responsive table-condensed table-striped" id="dev-table">
							<thead>
								<tr class="active info">
									...
									<th width="10%" class="translate" data-traducir_english="Seeds" data-traducir_spanish="Semillas">Semillas</th>
									<th width="15%" class="translate" data-traducir_english="Planting" data-traducir_spanish="Plantación">Plantación</th>
									<th width="10%" class="translate" data-traducir_english="Application Type" data-traducir_spanish="Tipo Aplicación">Tipo Aplicación</th>
									<th width="10%" class="translate" data-traducir_english="Assesment Date" data-traducir_spanish="Fecha">Fecha</th>
									<th width="10%" class="translate" data-traducir_english="Assesment Time" data-traducir_spanish="Tiempo">Tiempo</th>
									<th width="15%" class="translate" data-traducir_english="Product Code" data-traducir_spanish="Código Químicos">Código Químicos</th>
									<th width="15%" class="translate" data-traducir_english="Chemicals" data-traducir_spanish="Químicos">Químicos</th>
									<th width="15%" class="translate" data-traducir_english="EPA Number" data-traducir_spanish="Registro Ambiental">Registro Ambiental</th>
									<th width="15%" class="translate" data-traducir_english="Active Ingredients" data-traducir_spanish="Ingredientes Activos">Ingredientes Activos</th>
									<th width="15%" class="translate" data-traducir_english="Acre(s)" data-traducir_spanish="Acre(s)">Acre(s)</th>
									<th width="15%" class="translate" data-traducir_english="Type of Application" data-traducir_spanish="Tipo Aplicación">Tipo Aplicación</th>
									<th width="15%" class="translate" data-traducir_english="Equipment Name" data-traducir_spanish="Nombre Equipo">Nombre Equipo</th>
									<th width="15%" class="translate" data-traducir_english="Application Rate" data-traducir_spanish="Rango Aplicación">Rango Aplicación</th>
									<th width="15%" class="translate" data-traducir_english="Quantity Applied" data-traducir_spanish="Cantidad Aplicada">Cantidad Aplicada</th>
									<th width="15%" class="translate" data-traducir_english="Application Date" data-traducir_spanish="Fecha Aplicación">Fecha Aplicación</th>
									<th width="15%" class="translate" data-traducir_english="Application Start Time" data-traducir_spanish="Inicio Aplicación">Inicio Aplicación</th>
									<th width="15%" class="translate" data-traducir_english="Application End Time" data-traducir_spanish="Fin Aplicación">Fin Aplicación</th>
									<th width="15%" class="translate" data-traducir_english="Application Reason" data-traducir_spanish="Razón Aplicación">Razón Aplicación</th>
									<th width="15%" class="translate" data-traducir_english="REI Interval" data-traducir_spanish="Reingreso">Reingreso</th>
									<th width="15%" class="translate" data-traducir_english="PHI Interval" data-traducir_spanish="Precosecha">Precosecha</th>
									<th width="15%" class="translate" data-traducir_english="Wind Speed" data-traducir_spanish="Viento">Viento</th>
									<th width="15%" class="translate" data-traducir_english="Temperature" data-traducir_spanish="Temperatura">Temperatura</th>
								</tr>
							</thead>
							<tbody>
	                            <?PHP
	                            	...
	                            	if (count($PLANTACIONES)) {
	                            		...
	                            		foreach ($PLANTACIONES as $plantacion) {
	                            			$cuerpo_tabla .= '<tr>
	                            									...
	                            									<td>'.utf8_encode($plantacion['insectos']).'</td>
	                            									<td>'.utf8_encode($plantacion['enfermedades']).'</td>
	                            									<td>'.utf8_encode($plantacion['hierbas']).'</td>
	                            									<td>'.utf8_encode($plantacion['otros_danos']).'</td>'
	                            							.'</tr>';
	                       					$correlativo++;
	                            		}
										echo "<script type='text/javascript'>
												$('#modal_loading').modal('hide');
												crear_grafico(".$encurso.",".$finalizadas.");
											</script>";
	                                }
	                                else
