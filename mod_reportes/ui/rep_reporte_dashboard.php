	...
	$(document).ready(function(){
		...
		$( "#excel" ).click(function() {
			...
			if (error != 1) {
				...
				var url = "mod_reportes/funciones/rep_reporte_dashboard_excel.php?x1="+x1+"&x2="+x2;
		...
		$('#buscar').click(function(event) {
	        ...
	        if (error == 0) 
	        {
	            ...
	            $('#modal_loading').on('hidden.bs.modal', function () {            
	                $.ajax({
	                	url: 'mod_reportes/ui/rep_reporte_dashboard.php',
	                	type: 'POST',
	                	dataType: 'html',
	                	data: {
...
<div class="panel panel-default">
  	<div class="panel-body">
        <div class="page-header">
            <h1 class="translate" data-traducir_english="Dashboard Report" data-traducir_spanish="Reporte del Dashboard">Reporte del Dashboard</h1>
        </div>
		<div class="row">
			<div class="col-md-4">
						...
						<table class="table table-responsive table-condensed table-striped" id="dev-table">
							<thead>
								<tr class="active info">
									...
									<th width="5%" class="translate" data-traducir_english="Date" data-traducir_spanish="Fecha">Fecha</th>
									<th width="5%" class="translate" data-traducir_english="Location" data-traducir_spanish="Lugar">Lugar</th>
									<th width="35%" class="translate" data-traducir_english="Rooms" data-traducir_spanish="Cuartos">Cuartos</th>
									<th width="20%" class="translate" data-traducir_english="Times" data-traducir_spanish="Tiempos">Tiempos</th>
									<th width="20%" class="translate" data-traducir_english="Temperatures" data-traducir_spanish="Temperaturas">Temperaturas</th>
	                            ...
	                            <?PHP 
	                            	...
	                            	if (count($PLANTACIONES)) {
	                            		...
	                            		foreach ($PLANTACIONES as $plantacion) {
	                            			$cuerpo_tabla .= '<tr>
	                            									<td>'.$correlativo.'</td>
	                            									<td>'.utf8_encode($plantacion['fecha']).'</td>
	                            									<td>'.utf8_encode($plantacion['departamento']).'</td>
	                            									<td>'.utf8_encode($plantacion['cuartos']).'</td>
	                            									<td>'.utf8_encode($plantacion['tiempos']).'</td>
	                            									<td>'.utf8_encode($plantacion['temperaturas']).'</td>
	                            									<td>'.utf8_encode($plantacion['observaciones']).'</td>'
	                            							.'</tr>';
	                       					$correlativo++;
	                            		}
