...
<script type="text/javascript">
    ...
    btnAgregarNuevoProducto.on("click", function() {
        ...
        if (error == 0) {
            ...
            trCuerpoTablaProductosIniciales.innerHTML = "";
            $("#cantidad_total_pagar").val(parseFloat(arrProductosIniciales["monto_a_pagar_total_inicial_" + 0]).toLocaleString());
                                    ...
                                    <div class="responsive_table_container">
                                        <table class="table display row-border responsive" id="tabla_itemschecklist_productos_guardados">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>$ <?php echo  number_format($producto['precio_semilla'], 3); ?></td>
                                                                <td>$ <?php echo  number_format($producto['monto_pago_inmutable']); ?></td>
                                                                <td><?php echo utf8_encode($producto['unidad_medida']); ?></td>
                                                ...
                                                ?>
                                                <script>
                                                    $("#cantidad_total_pagar").val('$ <?php echo number_format($cantidadTotalAPagar); ?>')
                                                </script>
                                            </tbody>
                                        </table>
                                    </div>
