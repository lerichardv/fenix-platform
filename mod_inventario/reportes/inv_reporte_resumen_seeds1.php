<?PHP
/*
 * Reporte de Resumen de Seeds y Proyeccciones
 * @author      Dan Urquia
 * @date        2023-11--8
 */
...
<script type="text/javascript">
	...
	function crear_grafico(){
            ...
            $.ajax({
                    url: '../../mod_inventario/reportes/inv_reporte_resumen_seeds_ajax.php',
                    type: 'POST',
	...
	<div class="row">
		<div class="panel-body">
			<div class="page-header">
				<h1 class="translate" data-traducir_english="Seeds Summary Report" data-traducir_spanish="Reporte de Resumen de Semillas">Reporte de Resumen de Semillas</h1>
			</div>
		</div>
		<div class="row">
						<div class="col-md-3">
				...
				<div class="col-sm-12">
					<div class="panel panel-primary" style="overflow:auto;">
						<div class="panel-heading panel_cabecera">
							<h3 class="panel-title translate" data-traducir_english="Seeds Summary" data-traducir_spanish="Reporte de Resumen de Semillas">Resumen de Semillas</h3>
