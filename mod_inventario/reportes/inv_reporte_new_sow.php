...
<script type="text/javascript">
	...
	function crear_grafico(){
            ...
            $.ajax({
                    url: '../../mod_inventario/reportes/inv_reporte_new_sow_ajax.php',
                    type: 'POST',
	...
	<div class="row">
		<div class="panel-body">
			<div class="page-header">
				<h1 class="translate" data-traducir_english="Sows Report" data-traducir_spanish="Reporte de Siembras">Reporte de Siembras</h1>
			</div>
		</div>
		<div class="row">
						<div class="col-md-3">
								<div class="form-group input-group-sm date" id="">
												<label for="fecha_inicial" class="translate" data-traducir_english="Initial sow" data-traducir_spanish="Siembra inicial">Siembra inicial</label>
						...
						<div class="col-md-3">
								<div class="form-group input-group-sm date" id="">
										<label for="fecha_final" class="translate" data-traducir_english="Final sow" data-traducir_spanish="Siembra final">Siembra final</label>
				...
				<div class="col-sm-12">
					<div class="panel panel-primary" style="overflow:auto;">
						<div class="panel-heading panel_cabecera">
							<h3 class="panel-title translate" data-traducir_english="Sowings list" data-traducir_spanish="Listado de Siembras">Listado de Siembras</h3>
