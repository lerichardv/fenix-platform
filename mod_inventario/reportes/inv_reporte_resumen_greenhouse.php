<?PHP
/*
 * Reporte de Resumen de Seeds y Proyeccciones por Greenhouse
 * @author      Dan Urquia
 * @date        2023-12-18
 */
...
<script type="text/javascript">
	...
	//Trae la fecha del ultimo cambio del inventario con el cambio de Greenhou
	$('#cod_info_empresa').change(function(event) {

		if ($('#cod_info_empresa').val() == '-b'){
			return false;
		}
		$.ajax({
			url: '../../mod_inventario/reportes/inv_reporte_resumen_greenhouse_fechas.php',
			type: 'POST',
	...
	function crear_grafico(){
            $.ajax({
                    url: '../../mod_inventario/reportes/inv_reporte_resumen_greenhouse_ajax.php',
                    type: 'POST',
                    //dataType: 'default: Intelligent Guess (Other values: xml, json, script, or html)',
                    data:{
	...
	<div class="row">
		<div class="panel-body">
			<div class="page-header">
				<h1 class="translate" data-traducir_english="Seed Shortage-Surplus Report" data-traducir_spanish="Reporte de Escasez y Excedente de Semillas">Seed Shortage-Surplus Report</h1>
			</div>
		</div>
		<div class="row">
						...
						<div class="col-md-3">
								<div class="form-group input-group-sm date" id="">
												<label for="fecha_inicial" class="translate" data-traducir_english="Initial Sow" data-traducir_spanish="Cosecha Inicial">Cosecha Inicial</label>
						...
						<div class="col-md-3">
								<div class="form-group input-group-sm date" id="">
										<label for="fecha_final" class="translate" data-traducir_english="Final Sow" data-traducir_spanish="Cosecha final">Cosecha final</label>
				...
				<div class="col-sm-12">
					<div class="panel panel-primary" style="overflow:auto;">
						<div class="panel-heading panel_cabecera">
							<h3 class="panel-title translate" data-traducir_english="Seed Shortage-Surplus List" data-traducir_spanish="Listado de Escasez y Excedente de Semillas">Seed Shortage-Surplus List</h3>
