                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="word-wrap:break-word;font-size:0px;padding:19px 20px 19px 20px;" align="left">
                                                                <div style="cursor:auto;color:#000000;font-family:Cabin, sans-serif;font-size:15px;line-height:22px;text-align:left;"><h2 style="color: #F05D22; line-height: 100%;"><span style="color:#16a085;">New Purchase Order Approved</span></h2>
                                                                    <p>A new purchase order has been approved. Please go to B&W Farming to check it.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
...
$mail->Subject = 'Notification - New Purchase Order Approved';
...
if(!$mail->send()) 
{
    ...
    echo ('1|Error al notificar aprobación de nueva orden de compra|'. $mail->ErrorInfo);
    //echo ('1|Asignación de documento notificada');
} 
else 
{
    echo ('0|Ingreso de aprobación de orden de compra notificado');
}