...
<div class="row" align="center">
		 ...
		 <div class="col-md-6">
					 <div class="media-body">
						 ...
						 <small class="translate" data-traducir_english="Your password has more than three months of use. Please enter a new password to enter the B&W Farming system" data-traducir_spanish="Su contraseña tiene mas de tres meses de uso. Por favor ingrese una nueva contraseña para ingresar al sistema B&W Farming">Su contraseña tiene mas de tres meses de uso. Por favor ingrese una nueva contraseña para ingresar al sistema B&W Farming</small>
						 &nbsp;
					 </div>
		 </div>
			 <div class="col-md-3">
	 ...
	 <div class="col-md-4"><!-- Form -->
		 <form class="form" role="form" method="post">
					 <div id="div_nuevo_pass" class="form-group input-group-sm">
						 <label for="nuevo_pass" style="color: black;" class="translate" data-traducir_english="Pass" data-traducir_spanish="Contraseña">Contraseña</label>
						 <input id="nuevo_pass" name="nuevo_pass" type="password" class="form-control igualar_pass limpiar">
					 </div>
				 <div id="div_confirm_pass" class="form-group input-group-sm">
					 <label for="confirm_pass" style="color: black;" class="translate" data-traducir_english="Confirm Pass" data-traducir_spanish="Confirmar Contraseña">Confirmar Contraseña</label>
					 <input id="confirm_pass" name="confirm_pass" type="password" class="form-control igualar_pass limpiar">
				 </div>
				 <button id="guardar" name="guardar" class="btn btn-sm btn-primary btn-block translate" data-traducir_english="Save" data-traducir_spanish="Guardar" type="button" class="form-control" data-loading-text="Guardando...">Guardar</button>
		 </form>
	 </div>
	 <div class="col-md-4">
			 &nbsp;
