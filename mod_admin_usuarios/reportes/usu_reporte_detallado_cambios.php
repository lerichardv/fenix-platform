...
<script type="text/javascript">
    	...
    	$("#btn_todos_usuarios").click(function(event){
    		...
    		if ($(this).hasClass('allselected')) {
    			...
    			$('#cod_usuarios option').prop('selected', true);
					$('#cod_usuarios option').attr('selected', 'selected');
	...
	function llenar_tabla(){
	            ...
	            $.ajax({
	                    url: '../../mod_admin_usuarios/reportes/usu_reporte_detallado_cambios_ajax.php',
	                    type: 'POST',
	...
	<div class="row">
		<div class="panel-body">
			<div class="page-header">
				<h1 class="translate" data-traducir_english="Detailed Report of Password Changes" data-traducir_spanish="Reporte Detallado de Cambios de Contraseña">Reporte Detallado de Cambios de Contraseña</h1>
			</div>
		</div>
		<div class="row">
						<div class="col-md-3">
				...
				<div class="col-sm-12">
					<div class="panel panel-primary" style="overflow:auto;">
						<div class="panel-heading panel_cabecera">
							<h3 class="panel-title" class="translate" data-traducir_english="Detailed List of Password Changes by User" data-traducir_spanish="Listado Detallado de Cambios de Contraseña por Usuario">Listado Detallado de Cambios de Contraseña por Usuario</h3>
							...
							<table class="table table-condensed display" id="dev-table">
	                            <thead>
																<tr class="active info">
																		...
																		<th width="10%" class="translate" data-traducir_english="Changes" data-traducir_spanish="Cambios">Cambios</th>
																		<th width="10%" class="translate" data-traducir_english="Date" data-traducir_spanish="Fecha">Fecha</th>
																		<th width="60%" class="translate" data-traducir_english="Hours" data-traducir_spanish="Horas">Horas</th>
																</tr>
	                            </thead>
