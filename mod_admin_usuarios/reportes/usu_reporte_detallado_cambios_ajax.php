...
$(document).ready(function() {
        ...
        $( "#excel" ).click(function() {
            var url = "../../mod_admin_usuarios/reportes/usu_reporte_detallado_cambios_excel.php?x1=<?php echo $fecha_inicial; ?>&x2=<?php echo $fecha_final; ?>&x3=<?php echo $cods_user; ?>";
	...
	<div class="col-md-12">
		<div class="panel panel-primary" style="overflow:auto;">
            <div class="panel-heading panel_cabecera">
                    <h3 class="panel-title">Listado Detallada de Cambios de Contraseña por Usuario</h3>
								...
								foreach ($TENDENCIAS as $TENDENCIA)
								{
									$cuerpo_tabla .= '<tr>
                                          ...
                                          <td>'.utf8_encode($TENDENCIA['cambios']).'</td>
																					<td>'.utf8_encode($TENDENCIA['fecha_cambio']).'</td>
