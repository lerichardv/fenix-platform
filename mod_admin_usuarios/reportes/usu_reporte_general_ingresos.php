...
<script type="text/javascript">
	...
	function crear_grafico(){
            $.ajax({
                    url: '../../mod_admin_usuarios/reportes/usu_reporte_general_ingresos_ajax.php',
                    type: 'POST',
	...
	<div class="row">
		<div class="panel-body">
			<div class="page-header">
				<h1 class="translate" data-traducir_english="General Login Report to the System per Month" data-traducir_spanish="Reporte General de Ingresos al Sistema por Mes">Reporte General de Ingresos al Sistema por Mes</h1>
			</div>
		</div>
		<div class="row">
						<div class="col-md-3">
				...
				<div class="col-sm-12">
					<div class="panel panel-primary" style="overflow:auto;">
						<div class="panel-heading panel_cabecera">
							<h3 class="panel-title translate" data-traducir_english="General List of System Login" data-traducir_spanish="Listado General de Ingresos al Sistema">Listado General de Ingresos al Sistema</h3>
							...
							<table class="table table-condensed display" id="dev-table">
	                            <thead>
	                                <tr class="active info">
	                                    ...
	                                    <th width="30%" class="translate" data-traducir_english="Logins" data-traducir_spanish="Ingresos">Ingresos</th>
	                                </tr>
	                            </thead>
