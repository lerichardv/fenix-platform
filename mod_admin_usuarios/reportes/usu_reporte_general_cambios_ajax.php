...
$TENDENCIAS = $DB_USUARIO->get_cambios_tendencia($fecha_inicial, $fecha_final);
$titulo = "Gráfico de tendencia de cambios de constraseñas del " . $_POST['x1'] . ' a ' . $_POST['x2'];
$cuerpo = "";
if(count($TENDENCIAS) > 0){
        foreach ($TENDENCIAS as $TENDENCIA) {
                $cuerpo .= "{
                                name: '".utf8_encode($TENDENCIA['mes']).' | '.utf8_encode($TENDENCIA['cambios']) ."',
...
$(function () {
    ...
    $('#container1').highcharts({
        ...
        $( "#excel" ).click(function() {
            var url = "../../mod_admin_usuarios/reportes/usu_reporte_general_cambios_excel.php?x1=<?php echo $fecha_inicial; ?>&x2=<?php echo $fecha_final; ?>";
...
<div class="row" style="overflow:auto; min-width:100px;">
    ...
    <div class="row" style="overflow:auto; min-width:100px;">
            ...
            <div class="panel-heading panel_cabecera">
                <h3 class="panel-title">Listado General de Cambios de Contraseña</h3>
							...
							if(count($TENDENCIAS) > 0)
							{
								...
								foreach ($TENDENCIAS as $TENDENCIA)
								{
									$cuerpo_tabla .= '<tr>
                                          ...
                                          <td>'.utf8_encode($TENDENCIA['cambios']).'</td>
                                    </tr>';
									$correlativo++;
								}
							}
