...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('B1', 'Ingresos al Sistema ASJ del '.$fecha_inicial.' al '.$fecha_final);
// Titulo principal
...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('B2', 'Listado de ingresos al sistema por Usuario');
// Titulos de columnas
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Ingresos por Usuario');
// Set active sheet index to the first sheet, so Excel opens this as the first sheet
$objPHPExcel->setActiveSheetIndex(0);
// Redirect output to a client’s web browser (Excel2007)
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment;filename="Reporte de ingresos al sistema Mensuales '.date("Y-m-d").'.xlsx"');
