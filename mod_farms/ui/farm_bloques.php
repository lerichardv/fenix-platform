...
$BLOQUES = $DB_FARM->farm_listado_bloques();
...
$BLOQUE = $DB_FARM->farm_obtener_bloque($cod_bloque);
...
<script type="text/javascript">
	...
	function salirDelInputDeCantidad(idBloque, nombre_bloque) {
		...
		guardarCantidadIngresada(parseFloat(miInput.val()), parseFloat(miInput.val()), idBloque, nombre_bloque);
