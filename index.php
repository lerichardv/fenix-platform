...
/*ENV LOADER*/
include_once("libs/funciones/func_env.php");
/*WHITELIST*/
...
if (isset($_POST['usuario'])) {
    ...
    if ($intentos[0]['intento'] < 5) {
        ...
        if (isset($flag[0]['cod_usuario'])) {
            ...
            $_SESSION['php_access_token'] = $DB_USUARIO->usu_generar_token_sesion($_SESSION['cod_usuario']);
        ...
        ?>
            ...
            <div class="row">
                <div class="col-md-12" align="center">
                    <img src="libs/imgs/icons/logo.png" width="50%" style="max-width: 250px;" alt="Fenix">
                </div>
            </div>
            <hr>
            <div id="div_login">
